...
public class DrivePIDCoefficients {
    ...
    public static double VELOCITY_GAIN = 2.5; // for position control in drive movements
    ...
    public static double velocity_Ki = 0.35;
    public static double velocity_Kd = 0.0001;
