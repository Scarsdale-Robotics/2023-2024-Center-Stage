...
public class PIDStrafeTuner extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            // right 1000√2 ticks
            drive.driveByAngularEncoder(SpeedCoefficients.getAutonomousDriveSpeed(), 1000, 1000, 0);
            while (opModeIsActive() && !gamepad1.a);
            // left 1000√2 ticks
            drive.driveByAngularEncoder(SpeedCoefficients.getAutonomousDriveSpeed(), 1000, 1000, Math.PI);
            while (opModeIsActive() && !gamepad1.a);
        }
