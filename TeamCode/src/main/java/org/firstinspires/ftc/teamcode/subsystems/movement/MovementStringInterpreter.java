...
public class MovementStringInterpreter {
    ...
    private static class MovementString {
         ...
         * @param movementString      The MovementString to be converted.
    	...
    	public Movement toMovement() {
    		...
    		case "forward":
    			...
    			movement = forward(Integer.parseInt(params[0]));
    			break;
    			
    		case "backward":
    			if (params.length!=1) throwInterpretError();
    			movement = backward(Integer.parseInt(params[0]));
    			break;
    			
    		case "left":
    			if (params.length!=1) throwInterpretError();
    			movement = left(Integer.parseInt(params[0]));
    			break;
    			
    		case "right":
    			if (params.length!=1) throwInterpretError();
    			movement = right(Integer.parseInt(params[0]));
    			break;
    			
    		case "turnLeft":
    			if (params.length!=1) throwInterpretError();
    			movement = turnLeft(Integer.parseInt(params[0]));
    			break;
    			
    		case "turnRight":
    			if (params.length!=1) throwInterpretError();
    			movement = turnRight(Integer.parseInt(params[0]));
    			break;
    			
    		case "forwardLeft":
    			if (params.length!=2) throwInterpretError();
    			movement = forwardLeft(Integer.parseInt(params[0]), 
    					Integer.parseInt(params[1]));
    			break;
    			
    		case "forwardRight":
    			if (params.length!=2) throwInterpretError();
    			movement = forwardRight(Integer.parseInt(params[0]), 
    					Integer.parseInt(params[1]));
    			break;
    			
    		case "backwardLeft":
    			if (params.length!=2) throwInterpretError();
    			movement = backwardLeft(Integer.parseInt(params[0]), 
    					Integer.parseInt(params[1]));
    			break;
    			
    		case "backwardRight":
    			if (params.length!=2) throwInterpretError();
    			movement = backwardRight(Integer.parseInt(params[0]), 
    					Integer.parseInt(params[1]));
    			break;
    			
    		case "sleepFor":
    			if (params.length!=1) throwInterpretError();
    			movement = sleepFor(Long.parseLong(params[0]));
    			break;
    		...
    		case "setWrist":
    			if (params.length!=1) throwInterpretError();
    			movement = setWrist(Double.parseDouble(params[0]));
    			break;
    		...
    		case "lowerArm":
    			if (params.length!=1) throwInterpretError();
    			movement = lowerArm(Double.parseDouble(params[0]));
    			break;
    			
    		case "raiseArm":
    			if (params.length!=1) throwInterpretError();
    			movement = raiseArm(Double.parseDouble(params[0]));
    			break;
    	...
    	private void throwInterpretError() {
    		throw new IllegalArgumentException("Failed to interpret the movement "+toString());
    	}
