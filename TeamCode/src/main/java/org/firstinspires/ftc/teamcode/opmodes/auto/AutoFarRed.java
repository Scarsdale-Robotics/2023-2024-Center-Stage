...
public class AutoFarRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        int propLocation = autoUtil.placePurplePixelRed(500, false, telemetry);
        //propLocation = -1;
        ...
        if (propLocation == 2) {
            ...
            */
            ...
            drive.driveByEncoder(0.3, 0, 0, 1100); // strafe left to place pixel correctly
            inDep.changeElevation(-2200); // lower claw
            drive.driveByEncoder(0, -0.3, 0, 500); // move forwards

            drive.driveByEncoder(0, -0.3, 0, 3185); // moving forward to the spike mark tape4
            drive.driveByEncoder(0, 0, -0.5, 1830);  // turn right 180º (only needed to place pixel)
...
//            drive.driveByEncoder(0, -0.3, 0, 1); // brake
            drive.driveByEncoder(0, 0, -0.5, 890);  // turn right
            inDep.changeElevation(-2200); // lower claw
            drive.driveByEncoder(0.3, 0, 0, 100); // strafe left to the spike mark tape
